! function (t) {
  ...
  298: function (e, n, t) {
    ...
    t.r(n), t(40), (o = {
      ...
      saveReport: "/coyoteconsoleapi/_fr/designer.saveReport?reportId=#{id}",
      makePreview: "/coyoteconsoleapi/_fr/designer.previewReport?reportId=#{id}",
      getReport: "/coyoteconsoleapi/_fr/designer.getReport?reportId=#{id}&v=#{rand_hash}",
      getFunctions: "/coyoteconsoleapi/_fr/designer.getFunctions?reportId=#{id}",
      getCustomConfig: "/coyoteconsoleapi/_fr/designer.getConfig?reportId=#{id}",
      getConnectionTypes: "/coyoteconsoleapi/_fr/designer.getConnectionTypes",
      getConnectionTables: "/coyoteconsoleapi/_fr/designer.getConnectionTables?connectionType=#{connectionType}&connectionString=#{connectionString}",
      getConnectionStringProperties: "/coyoteconsoleapi/_fr/designer.getConnectionStringProperties?connectionType=#{connectionType}&connectionString=#{connectionString}",
      makeConnectionString: "/coyoteconsoleapi/_fr/designer.makeConnectionString?connectionType=#{connectionType}",
      "scale-mobile": .6,
      scale: 1,
      grid: 9.45,
      "sticky-grid": !0,
    ...
    }).notifications = "default", o["notifications-mobile"] = "default", window.config = o, n.default = o
  },
  40: function (e, n, t) {
    "use strict";
    var o, i, r, a, s, c, l, d;
