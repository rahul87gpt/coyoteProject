...
namespace Coyote.Console.App.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220823111943_AddFieldOutletSupplier")]
    partial class AddFieldOutletSupplier
    {
            ...
            modelBuilder.Entity("Coyote.Console.App.Models.JournalHeader", b =>
                {
                    ...
                    b.HasIndex("Date")
                        .HasName("IX_JournalHeader");

                    b.HasIndex("TillId");

                    b.HasIndex("UpdatedById");

                    b.HasIndex("Date", "OutletId")
                        .HasName("JHeade_Trading_Date");

                    b.HasIndex("Id", "OutletId")
                        .HasName("IX_JournalHeader_Date_Outlet_id");

                    b.HasIndex("OutletId", "Date")
                        .HasName("IX_JournalHeader_Outlet_Date_id");

                    b.HasIndex("Status", "TradingDate")
                        .HasName("IX_Jhead_Status_TradeDate");

                    b.HasIndex("Type", "TradingDate")
                        .HasName("IX_JHead_Tp_TrsDate");

                    b.HasIndex("OutletId", "IsDeleted", "HeaderDate")
                        .HasName("<IX_JournalHeader_Olet_IsDel_HDate>");

                    b.HasIndex("OutletId", "Type", "TradingDate")
                        .HasName("IX_JHead_Olet_Tp_TradDate");

                    b.HasIndex("Type", "Status", "TradingDate")
                        .HasName("IX_JHead_Tp_Sta_TradDate");

                    b.HasIndex("Status", "IsDeleted", "OutletId", "TradingDate")
                        .HasName("IX_JHead_Status_Del_OletId_TradeDate");
            ...
            modelBuilder.Entity("Coyote.Console.App.Models.OrderDetail", b =>
                {
                    ...
                    b.Property<float?>("FinalGSTAMT")
                        .HasColumnType("real");

                    b.Property<float?>("FinalLineTotal")
                        .HasColumnType("real");

                    b.Property<bool?>("GSTInd")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Coyote.Console.App.Models.POSMessages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedById = 1,
                            DateFrom = new DateTime(2022, 8, 13, 11, 19, 38, 26, DateTimeKind.Utc).AddTicks(6549),
                            DateTo = new DateTime(2022, 8, 28, 11, 19, 38, 26, DateTimeKind.Utc).AddTicks(7224),
            ...
            modelBuilder.Entity("Coyote.Console.App.Models.Transaction", b =>
                {
                    ...
                    b.HasIndex("DepartmentId", "Date")
                        .HasName("IX_transaction_OutletRanking");

                    b.HasIndex("Type", "Date")
                        .HasName("IX_Trans_Tp_Date");

                    b.HasIndex("Type", "PromoSales")
                        .HasName("IX_Trans_date_PromoSales");

                    b.HasIndex("ProductId", "Date", "OutletId")
                        .HasName("IX_Transaction_product_Date_outlet");

                    b.HasIndex("Type", "IsDeleted", "Date")
                        .HasName("IX_Trans_Tp_Del_Dt");

                    b.HasIndex("Type", "OutletId", "Date")
                        .HasName("ix_Transaction_type_outlet_Date");

                    b.HasIndex("Date", "ProductId", "Type", "OutletId", "TillId", "Sequence")
                        .HasName("IX_TransactionDateProductTypeTillSequence");
            ...
            modelBuilder.Entity("Coyote.Console.App.Models.AccountTransaction", b =>
                {
                    ...
                    b.HasOne("Coyote.Console.App.Models.AccountTransaction", "AccountTrxParent")
                        .WithMany()
            ...
            modelBuilder.Entity("Coyote.Console.App.Models.Product", b =>
                {
                    ...
                    b.HasOne("Coyote.Console.App.Models.Product", "ProdParent")
                        .WithMany()
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("Coyote.Console.App.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("Coyote.Console.App.Models.Transaction", "TrxParent")
                        .WithMany()
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("Coyote.Console.App.Models.TransactionReport", b =>
                {
                    ...
                    b.HasOne("Coyote.Console.App.Models.TransactionReport", "TrxReportParent")
                        .WithMany()
                        .HasForeignKey("ParentId");
