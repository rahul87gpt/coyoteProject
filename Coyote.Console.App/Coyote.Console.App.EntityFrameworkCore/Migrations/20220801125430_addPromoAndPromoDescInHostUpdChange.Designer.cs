...
namespace Coyote.Console.App.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220801125430_addPromoAndPromoDescInHostUpdChange")]
    partial class addPromoAndPromoDescInHostUpdChange
    {
            ...
            modelBuilder.Entity("Coyote.Console.App.Models.POSMessages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedById = 1,
                            DateFrom = new DateTime(2022, 7, 22, 12, 54, 25, 387, DateTimeKind.Utc).AddTicks(6463),
                            DateTo = new DateTime(2022, 8, 6, 12, 54, 25, 387, DateTimeKind.Utc).AddTicks(7199),
